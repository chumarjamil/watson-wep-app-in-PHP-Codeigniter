    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="action" value="hospital_contact_address_update" />
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="btn_hospital_contact_address_update">Update Address</button>
            </div>
        </div>
    </div>
</div>