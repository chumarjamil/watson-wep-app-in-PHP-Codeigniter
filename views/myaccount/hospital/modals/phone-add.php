    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="action" value="hospital_contact_phone_number_add" />
                <input type="hidden" name="contact_id" />
                <input type="hidden" name="xref_id" value="" />
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="btn_hospital_contact_phone_number_add">Add Phone Number</button>
            </div>
        </div>
    </div>
</div>