<div class="modal fade" id="contactUpdateModal" tabindex="-1" role="dialog" aria-labelledby="contactUpdateModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">Update Contact</h5>
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="action" value="hospital_contact_update" />
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="btn_hospital_contact_update">Update Contact</button>
            </div>
        </div>
    </div>
</div>