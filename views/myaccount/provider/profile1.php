<div class="contact-form profile-form">
	...
	<?php endif;?>
	<?php echo form_open('', ['id' => 'frm_provider_profile']); ?>
	<div class="form-group row">
        <label for="username" class="col-sm-2 col-form-label">Username</label>
        	<div class="col-sm-10"><input type="text" readonly class="form-control" placeholder="Username" value="<?php echo $user->getUserName();?>"></div>
	</div>
	<div class="form-group row">
	...
	<div class="form-group row">
        ...
        <div class="col-sm-10">
			<input type="text" readonly class="form-control" placeholder="Company Name" value="<?php echo $user_detail->getCompany()->getCompanyName();?>">
		</div>
	</div>
	<div class="form-group row">
