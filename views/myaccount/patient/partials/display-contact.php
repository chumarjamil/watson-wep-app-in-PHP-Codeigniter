<li class="list-group-item single-contact" data-id="<?php echo $contact->getId();?>" id="row-contact-<?php echo $contact->getId();?>">
    <div class="row pr-3">
        ...
        <div class="col-md-2 pr-0">
            <div class="btn-group pt-1 pull-right" style="padding-top:0.9em" role="group">
                    ...
                    <div class="card-body address-list alternate-grid">
                        ...
                        if($addresses && count($addresses)){
                            ...
                            foreach($addresses as $address){
                                $this->load->view('myaccount/patient/partials/display-address',['address'=>$address]);
                            }
                        }
                        ?>
                    ...
                    <?php 
                        ...
                        if($emails && count($emails)){
                            ...
                            foreach($emails as $email){
                                $this->load->view('myaccount/patient/partials/display-email',['email'=>$email]);
                            }
                        }
                        ?>
                    ...
                    <?php 
                        ...
                        if($phone_numbers && count($phone_numbers)){
                            foreach($phone_numbers as $phone_number){
                                $class='d-none';
                                $this->load->view('myaccount/patient/partials/display-phone',['phone_number'=>$phone_number]);
                            }
                        }
                        ?>
