    ...
    <div class="container">
        ...
        <div class="col-md-6">
            <div class="contact-form">
                ...
                <?php echo form_error('company_name', '<p class="gpt_form_error">', '</p>'); ?>
                <input type="text" class="form-control" placeholder="Service Provider Name" name="company_name">
